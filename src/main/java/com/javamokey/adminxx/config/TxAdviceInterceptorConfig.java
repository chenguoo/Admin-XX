...
public class TxAdviceInterceptorConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.javamokey.adminxx.modules.*.service.*.*(..))";
...
//        System.out.println("*************超时时间:" + requiredTx.getTimeout());
